var Stats = function() {
	...
	g = document.getElementById('band');
	...
	k.style.backgroundColor =
		'rgb(' + Math.floor(b.fps.bg.r / 2) + ',' + Math.floor(b.fps.bg.g / 2) + ',' + Math.floor(b.fps.bg.b / 2) + ')';
	...
	f.style.backgroundColor =
		'rgb(' + Math.floor(b.ms.bg.r / 2) + ',' + Math.floor(b.ms.bg.g / 2) + ',' + Math.floor(b.ms.bg.b / 2) + ')';
	...
	h.style.backgroundColor =
		'rgb(' + Math.floor(b.mb.bg.r / 2) + ',' + Math.floor(b.mb.bg.g / 2) + ',' + Math.floor(b.mb.bg.b / 2) + ')';
