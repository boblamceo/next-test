export const talkingCalculator = `<!DOCTYPE html>
<html lang="en">
...
var name = prompt("What's your name?", 'idiot');
    ...
    setTimeout(() => {
        ...
        \else {
            responsiveVoice.speak(\`Hello \${name}. I am Wendy's Nuts. Please Do not divide by zero. It is a forbidden action. Anyway, I'm gonna sing a song. \`, "UK English Male", {pitch: 4, rate: 1.2})  
            responsiveVoice.speak(\`Never gonna give you up
